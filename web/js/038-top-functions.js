...
(function() {
	...
	TopFunctions.setTitle = function(id, singleMedia) {
		...
		if (singleMedia === null) {
			mediaTotalInAlbum = currentAlbum.media.length;
		...
		if (singleMedia === null && currentAlbum !== null && ! currentAlbum.subalbums.length && currentAlbum.media.length == 1) {
