...
def report_times(final):
	...
	if num_media > 0 and Options.config['num_media_in_tree'] > 0:
		...
		print("                                  without exif date and geotags      " + _num_photo_without_exif_date_or_geotags.rjust(max_digit))
		# if final:
		...
		print("                                  without exif data but with geotags " + _num_photo_without_exif_date_and_with_geotags.rjust(max_digit))
		# if final:
