# MyPhotoShare v5.5.1 - A Static Web Photo Gallery with Advanced Features (December 5, 2021)
...
- [x] Optional feature: the user can be given the ability to suggest the location of the photos missing it; the suggestion is sent by a reserved mail to the site owner
...
1. `cd`
1. `wget https://gitlab.com/paolobenve/myphotoshare/-/archive/master/myphotoshare-master.zip`
